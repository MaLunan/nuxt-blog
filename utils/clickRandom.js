window.onload = function() {
	...
	function ClickFrontShow() {
		//定义所需文字和颜色
		this.fron = ['和平', '友善', '富强', '敬业', '民主', '文明', '和谐', '自由', '平等', '法治', '爱国', '诚信'];
	...
	ClickFrontShow.prototype.createFront = function (classname) {
		...
		//设置样式
		let cssText = "position:fixed; width: 40px; height: 20px; cursor: default;font-size:18px !important; transform: translate(-50%,-50%); font-weight: bold; opacity: 1; z-index: 1000; transition: 1s;";
		//随机字体和颜色
